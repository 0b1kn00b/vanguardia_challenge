...
typedef SecureServerOptions = {
	...
	var Http1IncomingMessage : {
		...
		**/
		...
		@:overload(function(emitter:SecureServerOptions, event:String):js.lib.Promise<Array<Dynamic>> { })
		function once(emitter:SecureServerOptions, event:ts.AnyOf2<String, js.lib.Symbol>):js.lib.Promise<Array<Dynamic>>;
