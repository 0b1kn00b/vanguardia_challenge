...
var auction_server_router_api_auction_Operation = $hxEnums["auction.server.router.api.auction.Operation"] = { __ename__:"auction.server.router.api.auction.Operation",__constructs__:null
...
auction_server_test_AuctionTest.__name__ = "auction.server.test.AuctionTest";
...
auction_server_test_AuctionTest.prototype = $extend(utest_Test.prototype,{
	test_immutability: function() {
		...
		stx_nano_PledgeLift.fudge(auction_model.insert(auction));
		var self = stx_nano_PledgeLift.fudge(auction_model.values());
		var tmp;
		switch(self._hx_index) {
		case 0:
			var t = self.t;
		...
		var self = stx_nano_PledgeLift.fudge(user_model.locate(0));
		var user;
		switch(self._hx_index) {
		case 0:
			var t = self.t;
		...
		var hrtime = process.hrtime();
		var bid3 = bid.make(bid1,bid2,100000000,hrtime[0] + hrtime[1] / 1e9);
		var result = stx_nano_PledgeLift.fudge(auction_model.place_bid(auction.get_uid(),bid3));
		haxe_Log.trace(bid_model.data,{ fileName : "src/main/haxe/auction/server/test/AuctionTest.hx", lineNumber : 30, className : "auction.server.test.AuctionTest", methodName : "test_immutability"});
	...
	,__initializeUtest__: function() {
		var _gthis = this;
		var init = utest_Test.prototype.__initializeUtest__.call(this);
		init.tests.push({ name : "test_immutability", dependencies : [], execute : function() {
			_gthis.test_immutability();
...
auction_server_test_RouterTest.__name__ = "auction.server.test.RouterTest";
...
auction_server_test_RouterTest.prototype = $extend(utest_Test.prototype,{
	...
	,__class__: auction_server_test_RouterTest
});
var auction_server_test_SaleableTest = function() {
	utest_Test.call(this);
};
auction_server_test_SaleableTest.__name__ = "auction.server.test.SaleableTest";
...
auction_server_test_TinkPureTest.__name__ = "auction.server.test.TinkPureTest";
auction_server_test_TinkPureTest.__super__ = utest_Test;
auction_server_test_TinkPureTest.prototype = $extend(utest_Test.prototype,{
	test: function() {
	}
	,__initializeUtest__: function() {
		var _gthis = this;
	...
	,__class__: auction_server_test_TinkPureTest
});
var auction_server_test_UserTest = function() {
	utest_Test.call(this);
};
auction_server_test_UserTest.__name__ = "auction.server.test.UserTest";
...
auction_server_test_UserTest.prototype = $extend(utest_Test.prototype,{
	test: function() {
		...
		utest_Assert.isFalse(result,null,{ fileName : "src/main/haxe/auction/server/test/UserTest.hx", lineNumber : 12, className : "auction.server.test.UserTest", methodName : "test"});
		utest_Assert.equals(1,session_model.data.length,null,{ fileName : "src/main/haxe/auction/server/test/UserTest.hx", lineNumber : 14, className : "auction.server.test.UserTest", methodName : "test"});
	}
	,__initializeUtest__: function() {
		var _gthis = this;
		var init = utest_Test.prototype.__initializeUtest__.call(this);
...
var golgi_Error = $hxEnums["golgi.Error"] = { __ename__:"golgi.Error",__constructs__:null
...
stx_log_Logger.prototype = $extend(stx_log_output_term_Full.prototype,{
	...
	,do_apply: function(value) {
		...
		return stx_fp_Continuation.lift(function(fn) {
			var result = stx_nano_Report.populate(stx_log_Logic.apply(_gthis.logic,value),function() {
...
stx_log_logger_Default.prototype = $extend(stx_log_Logger.prototype,{
	...
	,do_apply: function(value) {
		var _gthis = this;
		var self = (stx_log_Logger.prototype.do_apply.call(this,value))(function(_) {
...
stx_log_Format.unit = function() {
	var this1 = stx_log_Format.get_DEFAULT();
	return this1;
};
...
stx_Test.test = function(test,only) {
	...
	(function(value,pos) {
		this3(value,fn2(pos));
	})(test,{ fileName : "stx/Test.hx", lineNumber : 29, className : "stx.Test", methodName : "test"});
	utest_UTest.run(test);
};
...
stx_assert_assertion_term_GreaterThan.prototype = $extend(stx_assert_assertion_term_Base.prototype,{
	applyII: function(a,b) {
		var l = a;
		var r = b;
		return stx_LiftAssert.report(l > r,this.error(null,null,{ fileName : "stx/assert/assertion/term/GreaterThan.hx", lineNumber : 11, className : "stx.assert.assertion.term.GreaterThan", methodName : "applyII"}));
	}
...
stx_assert_assertion_term_GreaterThanOrEquals.prototype = $extend(stx_assert_assertion_term_Base.prototype,{
	applyII: function(a,b) {
		var l = a;
		var r = b;
		return stx_LiftAssert.report(l >= r,this.error(null,null,{ fileName : "stx/assert/assertion/term/GreaterThanOrEquals.hx", lineNumber : 11, className : "stx.assert.assertion.term.GreaterThanOrEquals", methodName : "applyII"}));
	}
...
stx_assert_assertion_term_LessThan.prototype = $extend(stx_assert_assertion_term_Base.prototype,{
	applyII: function(a,b) {
		var l = a;
		var r = b;
		return stx_LiftAssert.report(l < r,this.error(null,null,{ fileName : "stx/assert/assertion/term/LessThan.hx", lineNumber : 10, className : "stx.assert.assertion.term.LessThan", methodName : "applyII"}));
	}
...
stx_assert_assertion_term_LessThanOrEquals.prototype = $extend(stx_assert_assertion_term_Base.prototype,{
	applyII: function(a,b) {
		var l = a;
		var r = b;
		return stx_LiftAssert.report(l <= r,this.error(null,null,{ fileName : "stx/assert/assertion/term/LessThanOrEquals.hx", lineNumber : 10, className : "stx.assert.assertion.term.LessThanOrEquals", methodName : "applyII"}));
	}
...
stx_assert_predicate_term_Not.prototype = $extend(stx_assert_predicate_term_Open.prototype,{
	predicate: null
	,applyI: function(v) {
		var self = this.predicate.applyI(v);
		var bool;
		switch(self._hx_index) {
		case 0:
			var t = self.v;
