...
Server.play = function(context) {
	haxe_Log.trace(process.cwd(),{ fileName : "Server.hx", lineNumber : 16, className : "Server", methodName : "play"});
	var router = auction_server_Module.router();
	var express = Express();
	var static_ = Express.static("public");
	var ws = ExpressWs(express);
	var wss = ws.app;
	var tmp = auction_server_ws_Handler.toWebsocketRequestHandler(auction_server_ws_Handler._new(auction_server_ws_Module.router(),context));
	wss.ws("/api",tmp);
	wss.use(static_);
...
Server.main = function() {
	var context = new auction_server_model_server_$context_ContextInServerSchema().mock();
...
var auction_common_Protocol = $hxEnums["auction.common.Protocol"] = { __ename__:true,__constructs__:null
	,P_OutgoingClientRequest: ($_=function(req) { return {_hx_index:0,req:req,__enum__:"auction.common.Protocol",toString:$estr}; },$_._hx_name="P_OutgoingClientRequest",$_.__params__ = ["req"],$_)
	,P_IncomingClientResponse: ($_=function(res) { return {_hx_index:1,res:res,__enum__:"auction.common.Protocol",toString:$estr}; },$_._hx_name="P_IncomingClientResponse",$_.__params__ = ["res"],$_)
};
auction_common_Protocol.__constructs__ = [auction_common_Protocol.P_OutgoingClientRequest,auction_common_Protocol.P_IncomingClientResponse];
var auction_common_form_SignInForm = function(name,pass) {
	this.name = name;
	this.pass = pass;
};
$hxClasses["auction.common.form.SignInForm"] = auction_common_form_SignInForm;
...
$hxClasses["auction.common.model.api.ApiApi"] = auction_common_model_api_ApiApi;
...
$hxClasses["auction.common.model.api.ApiCls"] = auction_common_model_api_ApiCls;
...
$hxClasses["auction.common.model.api.ApiSchema"] = auction_common_model_api_ApiSchema;
...
$hxClasses["stx.data.store.StoreApi"] = stx_data_store_StoreApi;
...
$hxClasses["stx.data.store.StoreInMemory"] = stx_data_store_StoreInMemory;
...
$hxClasses["auction.common.model.store.StoreInMemory"] = auction_common_model_store_StoreInMemory;
...
$hxClasses["auction.common.model.store.StoreApi"] = auction_common_model_store_StoreApi;
...
$hxClasses["auction.common.model.auction.AuctionModelApi"] = auction_common_model_auction_AuctionModelApi;
...
$hxClasses["auction.common.model.auction.AuctionMemoryModel"] = auction_common_model_auction_AuctionMemoryModel;
...
$hxClasses["auction.common.model.auction.AuctionSchema"] = auction_common_model_auction_AuctionSchema;
...
$hxClasses["stx.data.store.UniqueKey"] = stx_data_store_UniqueKey;
...
$hxClasses["auction.common.model.auction.AuctionVO"] = auction_common_model_auction_AuctionVO;
...
$hxClasses["auction.common.model.bid.BidModelApi"] = auction_common_model_bid_BidModelApi;
...
$hxClasses["auction.common.model.bid.BidMemoryModel"] = auction_common_model_bid_BidMemoryModel;
...
$hxClasses["auction.common.pack.Counter"] = auction_common_pack_Counter;
...
$hxClasses["auction.common.model.bid.BidSchema"] = auction_common_model_bid_BidSchema;
...
$hxClasses["auction.common.model.bid.BidVO"] = auction_common_model_bid_BidVO;
...
$hxClasses["auction.common.model.context.ContextApi"] = auction_common_model_context_ContextApi;
...
$hxClasses["auction.common.model.context.ContextCls"] = auction_common_model_context_ContextCls;
...
$hxClasses["auction.common.model.context.ContextSchema"] = auction_common_model_context_ContextSchema;
...
$hxClasses["auction.common.model.saleable.SaleableModelApi"] = auction_common_model_saleable_SaleableModelApi;
...
$hxClasses["auction.common.model.saleable.SaleableMemoryModel"] = auction_common_model_saleable_SaleableMemoryModel;
...
$hxClasses["auction.common.model.saleable.SaleableMockMemoryModel"] = auction_common_model_saleable_SaleableMockMemoryModel;
...
$hxClasses["auction.common.model.saleable.SaleableSchema"] = auction_common_model_saleable_SaleableSchema;
...
$hxClasses["auction.common.model.saleable.SaleableVO"] = auction_common_model_saleable_SaleableVO;
...
$hxClasses["auction.common.model.session.SessionModelApi"] = auction_common_model_session_SessionModelApi;
...
$hxClasses["auction.common.model.session.SessionMemoryModel"] = auction_common_model_session_SessionMemoryModel;
...
$hxClasses["auction.common.model.session.SessionSchema"] = auction_common_model_session_SessionSchema;
...
$hxClasses["auction.common.model.session.SessionVO"] = auction_common_model_session_SessionVO;
...
$hxClasses["auction.common.model.user.UserModelApi"] = auction_common_model_user_UserModelApi;
...
$hxClasses["auction.common.model.user.UserMockMemoryModel"] = auction_common_model_user_UserMockMemoryModel;
...
$hxClasses["auction.common.model.user.UserSchema"] = auction_common_model_user_UserSchema;
...
$hxClasses["auction.common.model.user.UserVO"] = auction_common_model_user_UserVO;
...
var auction_common_protocol_AuctionProtocol = $hxEnums["auction.common.protocol.AuctionProtocol"] = { __ename__:true,__constructs__:null
	,Start: ($_=function(form) { return {_hx_index:0,form:form,__enum__:"auction.common.protocol.AuctionProtocol",toString:$estr}; },$_._hx_name="Start",$_.__params__ = ["form"],$_)
};
auction_common_protocol_AuctionProtocol.__constructs__ = [auction_common_protocol_AuctionProtocol.Start];
var auction_common_protocol_IncomingClientResponse = $hxEnums["auction.common.protocol.IncomingClientResponse"] = { __ename__:true,__constructs__:null
};
auction_common_protocol_IncomingClientResponse.__constructs__ = [];
var auction_common_protocol_OutgoingClientRequest = $hxEnums["auction.common.protocol.OutgoingClientRequest"] = { __ename__:true,__constructs__:null
};
auction_common_protocol_OutgoingClientRequest.__constructs__ = [];
var auction_common_protocol_UserProtocol = $hxEnums["auction.common.protocol.UserProtocol"] = { __ename__:true,__constructs__:null
	,SignIn: ($_=function(form) { return {_hx_index:0,form:form,__enum__:"auction.common.protocol.UserProtocol",toString:$estr}; },$_._hx_name="SignIn",$_.__params__ = ["form"],$_)
};
auction_common_protocol_UserProtocol.__constructs__ = [auction_common_protocol_UserProtocol.SignIn];
...
$hxClasses["auction.server.HandlerLift"] = auction_server_HandlerLift;
...
$hxClasses["auction.server.Module"] = auction_server_Module;
...
var auction_server_model_server_$context_ContextInServerApi = function() { };
$hxClasses["auction.server.model.server_context.ContextInServerApi"] = auction_server_model_server_$context_ContextInServerApi;
auction_server_model_server_$context_ContextInServerApi.__name__ = "auction.server.model.server_context.ContextInServerApi";
auction_server_model_server_$context_ContextInServerApi.__isInterface__ = true;
auction_server_model_server_$context_ContextInServerApi.__interfaces__ = [auction_common_model_context_ContextApi];
var auction_server_model_server_$context_ContextInServerCls = function(api) {
	auction_common_model_context_ContextCls.call(this,api);
};
$hxClasses["auction.server.model.server_context.ContextInServerCls"] = auction_server_model_server_$context_ContextInServerCls;
auction_server_model_server_$context_ContextInServerCls.__name__ = "auction.server.model.server_context.ContextInServerCls";
auction_server_model_server_$context_ContextInServerCls.__interfaces__ = [auction_server_model_server_$context_ContextInServerApi];
auction_server_model_server_$context_ContextInServerCls.__super__ = auction_common_model_context_ContextCls;
auction_server_model_server_$context_ContextInServerCls.prototype = $extend(auction_common_model_context_ContextCls.prototype,{
	__class__: auction_server_model_server_$context_ContextInServerCls
});
var auction_server_model_server_$context_ContextInServerSchema = function() {
	stx_pico_Clazz.call(this);
};
$hxClasses["auction.server.model.server_context.ContextInServerSchema"] = auction_server_model_server_$context_ContextInServerSchema;
auction_server_model_server_$context_ContextInServerSchema.__name__ = "auction.server.model.server_context.ContextInServerSchema";
auction_server_model_server_$context_ContextInServerSchema.__super__ = stx_pico_Clazz;
auction_server_model_server_$context_ContextInServerSchema.prototype = $extend(stx_pico_Clazz.prototype,{
	mock: function() {
		var data = new auction_common_model_context_ContextSchema().mock();
		return stx_nano_Pledge.map(data,function(context) {
			var next = new auction_server_model_server_$context_ContextInServerCls(context.api);
			return next;
		});
	}
	,__class__: auction_server_model_server_$context_ContextInServerSchema
});
...
$hxClasses["golgi.Golgi"] = golgi_Golgi;
...
$hxClasses["auction.server.router.Golgi"] = auction_server_router_Golgi;
...
$hxClasses["auction.server.router.Routes"] = auction_server_router_Routes;
...
$hxClasses["auction.server.router.api.Golgi"] = auction_server_router_api_Golgi;
...
$hxClasses["auction.server.router.api.Routes"] = auction_server_router_api_Routes;
...
$hxClasses["auction.server.router.api.auction.Golgi"] = auction_server_router_api_auction_Golgi;
...
$hxClasses["auction.server.router.api.auction.Routes"] = auction_server_router_api_auction_Routes;
...
$hxClasses["auction.server.router.api.bid.Golgi"] = auction_server_router_api_bid_Golgi;
...
$hxClasses["auction.server.router.api.bid.Routes"] = auction_server_router_api_bid_Routes;
...
$hxClasses["auction.server.router.api.saleable.Golgi"] = auction_server_router_api_saleable_Golgi;
...
$hxClasses["auction.server.router.api.saleable.Routes"] = auction_server_router_api_saleable_Routes;
...
$hxClasses["auction.server.router.api.session.Golgi"] = auction_server_router_api_session_Golgi;
...
$hxClasses["auction.server.router.api.session.Routes"] = auction_server_router_api_session_Routes;
...
$hxClasses["auction.server.router.api.user.Golgi"] = auction_server_router_api_user_Golgi;
...
$hxClasses["auction.server.router.api.user.Routes"] = auction_server_router_api_user_Routes;
...
$hxClasses["auction.server.ws.HandlerLift"] = auction_server_ws_HandlerLift;
auction_server_ws_HandlerLift.__name__ = "auction.server.ws.HandlerLift";
var auction_server_ws_Handler = {};
auction_server_ws_Handler._new = function(router,model) {
	var handler = new auction_server_ws_HandlerImpl(model);
	haxe_Log.trace("created",{ fileName : "src/main/haxe/auction/server/ws/Handler.hx", lineNumber : 9, className : "auction.server.ws._Handler.Handler_Impl_", methodName : "_new"});
	var this1 = function(ws,req,next) {
		haxe_Log.trace("routing",{ fileName : "src/main/haxe/auction/server/ws/Handler.hx", lineNumber : 11, className : "auction.server.ws._Handler.Handler_Impl_", methodName : "_new"});
		ws.on("message",function(msg) {
			var decode = haxe_Unserializer.run(msg);
			haxe_Log.trace(decode,{ fileName : "src/main/haxe/auction/server/ws/Handler.hx", lineNumber : 14, className : "auction.server.ws._Handler.Handler_Impl_", methodName : "_new"});
			handler.apply(decode);
		});
		ws.on("open",function() {
			haxe_Log.trace("connected",{ fileName : "src/main/haxe/auction/server/ws/Handler.hx", lineNumber : 19, className : "auction.server.ws._Handler.Handler_Impl_", methodName : "_new"});
		});
	};
	return this1;
};
...
var auction_server_ws_HandlerImpl = function(model) {
	this.model = model;
};
$hxClasses["auction.server.ws.HandlerImpl"] = auction_server_ws_HandlerImpl;
auction_server_ws_HandlerImpl.__name__ = "auction.server.ws.HandlerImpl";
auction_server_ws_HandlerImpl.prototype = {
	model: null
	,apply: function(protocol) {
		haxe_Log.trace(protocol,{ fileName : "src/main/haxe/auction/server/ws/Handler.hx", lineNumber : 40, className : "auction.server.ws.HandlerImpl", methodName : "apply"});
	}
	,__class__: auction_server_ws_HandlerImpl
};
var auction_server_ws_Module = function() { };
$hxClasses["auction.server.ws.Module"] = auction_server_ws_Module;
...
$hxClasses["golgi.MetaGolgi"] = golgi_MetaGolgi;
...
$hxClasses["golgi.Subroute"] = golgi_Subroute;
...
$hxClasses["golgi.Validate"] = golgi_Validate;
...
$hxClasses["stx.data.store.StoreBackedApi"] = stx_data_store_StoreBackedApi;
...
$hxClasses["stx.data.store.StoreBackedAbs"] = stx_data_store_StoreBackedAbs;
...
$hxClasses["stx.data.store.StoreSchemaApi"] = stx_data_store_StoreSchemaApi;
...
$hxClasses["stx.data.store.StoreInMemorySchema"] = stx_data_store_StoreInMemorySchema;
...
$hxClasses["stx.fn._Thunk.Constructor"] = stx_fn__$Thunk_Constructor;
...
$hxClasses["stx.fn.Destructure"] = stx_fn_Destructure;
...
var stx_fp_Fix = $hxEnums["stx.fp.Fix"] = { __ename__:true,__constructs__:null
...
var stx_fp_FreeFSum = $hxEnums["stx.fp.FreeFSum"] = { __ename__:true,__constructs__:null
...
var stx_fp_LazyStreamSum = $hxEnums["stx.fp.LazyStreamSum"] = { __ename__:true,__constructs__:null
...
$hxClasses["stx.nano.Err"] = stx_nano_Err;
...
$hxClasses["stx.nano.FailureLift"] = stx_nano_FailureLift;
