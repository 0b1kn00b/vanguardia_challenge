...
var haxe_net_example_WebSocketExample = function() { };
haxe_net_example_WebSocketExample.__name__ = true;
haxe_net_example_WebSocketExample.main = function() {
	console.log("src/haxe/net/example/WebSocketExample.hx:5:","testing!");
	var ws = haxe_net_WebSocket.create("ws://127.0.0.1:8000/",["echo-protocol"],null,false);
	ws.onopen = function() {
		console.log("src/haxe/net/example/WebSocketExample.hx:8:","open!");
	...
	ws.onmessageString = function(message) {
		console.log("src/haxe/net/example/WebSocketExample.hx:18:","message from server!" + (message.length > 200 ? HxOverrides.substr(message,0,200) + "..." : message));
		console.log("src/haxe/net/example/WebSocketExample.hx:19:","message.length=" + message.length);
	};
};
var haxe_net_impl_WebSocketJs = function(url,protocols) {
	...
	this.impl.onmessage = function(e) {
		...
		if(typeof(m) == "string") {
			...
			console.log("src/haxe/net/impl/WebSocketJs.hx:47:","Unhandled websocket onmessage " + m);
		}
	};
};
...
haxe_net_example_WebSocketExample.main();
