...
Client.main = function() {
	console.log("Client.hx:5:","running");
	var ws = haxe_net_WebSocket.create("ws://127.0.0.1:3000/",["echo-protocol"],null,false);
	ws.onopen = function() {
		console.log("Client.hx:8:","open!");
	};
	ws.onmessageString = function(message) {
		console.log("Client.hx:11:","message from server!" + (message.length > 200 ? HxOverrides.substr(message,0,200) + "..." : message));
		console.log("Client.hx:12:","message.length=" + message.length);
	};
	ws.onerror = function(message) {
		console.log("Client.hx:15:","error: " + message);
	};
};
