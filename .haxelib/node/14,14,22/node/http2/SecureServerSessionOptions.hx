...
typedef SecureServerSessionOptions = {
	...
	var Http1IncomingMessage : {
		...
		**/
		...
		@:overload(function(emitter:SecureServerSessionOptions, event:String):js.lib.Promise<Array<Dynamic>> { })
		function once(emitter:SecureServerSessionOptions, event:ts.AnyOf2<String, js.lib.Symbol>):js.lib.Promise<Array<Dynamic>>;
